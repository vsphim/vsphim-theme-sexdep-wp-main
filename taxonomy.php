...
<div id="main-wrapper" class="layout-page page-category">
    <div class="top-banner">
        ...
        <div class="top-fixed"><h1><?= single_tag_title(); ?></h1><p class="d-none d-md-block"><?= single_tag_title(); ?> được update liên tục</p><p class="d-block d-md-none"><?= single_tag_title(); ?> được update liên tục</p></div>
